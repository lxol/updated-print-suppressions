...
@Singleton
class MongoCounterRepository @Inject()(mongoComponent: ReactiveMongoComponent) extends ReactiveRepository[Counter, BSONObjectID](
  "counters", mongoComponent.mongoConnector.db, Counter.formats, ReactiveMongoFormats.objectIdFormats) with CounterRepository {
